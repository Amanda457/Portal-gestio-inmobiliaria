<x-layout>
    ...
    <x-nav url="{{ route('clients.create') }}" />
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            <thead class="text-xs text-gray-700 uppercase bg-green-100 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th class="px-4 py-2 text-center">Cognom</th>
                    <th class="px-4 py-2 text-center">Telèfon</th>
                    <th class="px-4 py-2 text-center">Data de naixement</th>
                    <th class="px-4 py-2 text-center">Correu electrònic</th>
